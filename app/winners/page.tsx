...
export const metadata = {
  title: "Daily Winners - AI SaaS",
  description: "Check out the daily winners on AI SaaS",
}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 p-5 pt-0">
              ...
              <div className="dark:bg-secondary/10 rounded-md border border-zinc-100 bg-white p-4 shadow-[0_1px_3px_rgba(0,0,0,0.05)] dark:border-zinc-800/50">
                <p className="text-muted-foreground text-sm">
                  Each day, AI SaaS automatically ranks the top 3 most upvoted projects that
                  were launched.
                </p>
              </div>
            </div>
