...
export const metadata = {
  title: "Attribution Badges - AI SaaS",
  description: "Official attribution badges for AI SaaS License compliance",
}

export default function AttributionBadgesPage() {
  const lightBadgeCode = `<a href="https://open-launch.com" target="_blank" title="Powered by AI SaaS">
  <img 
    src="https://open-launch.com/images/badges/powered-by-light.svg" 
    alt="Powered by AI SaaS" 
    width="150" 
    height="44"
  />
</a>`

  const darkBadgeCode = `<a href="https://open-launch.com" target="_blank" title="Powered by AI SaaS">
  <img 
            ...
            <section>
              ...
              <div className="mb-4 rounded-r-lg border-l-4 border-red-500 bg-red-50 p-4 dark:bg-red-950/20">
                ...
                <p className="text-sm text-red-700 dark:text-red-300">
                  If you use AI SaaS, you MUST display a visual badge on ALL pages of your
